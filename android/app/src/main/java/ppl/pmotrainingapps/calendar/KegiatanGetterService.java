...
public class KegiatanGetterService extends IntentService {
    ...
    public static void startActionFoo(Context context, String param1, String param2) {
        Intent intent = new Intent(context, KegiatanGetterService.class);
...
//        final ResultReceiver receiver = intent.getParcelableExtra("receiver");
    ...
    private void getKegiatanData(String stringUrl) {
        ...
        try{
            ...
            if(connection.getResponseCode() == 200) {
                ...
                dapetQuote.putExtra("kegiatanJSON",result.toString());
